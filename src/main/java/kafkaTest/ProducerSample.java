...
public class ProducerSample {
	...
	public void init() {
		...
		/**
		 * 消息的序列化类 默认是 kafka.serializer.DefaultEncoder， 输入时 byte[] 返回是同样的字节数组
		 */
		...
		// 泛型参数分别表示 The first is the type of the Partition key, the second the type of
		// the message
	...
	public void produceMsg() {
		...
		/**
		 * topic: 消息的主题 key：消息的key，同时也会作为partition的key message:发送的消息
		 */
